...
async function uiSignIn() {
    ...
    const usernameElement = signOutBtn.querySelector("#judge0-puter-username");
    if (usernameElement) {
        usernameElement.innerText = (await puter.auth.getUser()).username;
    }
...
function uiSignOut() {
    ...
    const usernameElement = signOutBtn.querySelector("#judge0-puter-username");
    if (usernameElement) {
        usernameElement.innerText = "Sign out";
    }
